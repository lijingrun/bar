...
//        $scategories = $scategory_mod->get_list(-1,true);
        //后来因为蓝羽要上PC端，墙纸粘贴不需要用，直接换查询语句
        $scategories = $scategory_mod->find('cate_id = 1 OR cate_id = 2');
//        print_r($scategories);exit;
        import('tree.lib');
        $tree = new Tree();
	...
	function lanyu_store()
	{
        $this->display('lanyu.store.html');
	}
}
