 ...
 */
class Taocz_slidesWidget extends BaseWidget
{
    var $_name = 'taocz_slides';
	var $_ttl  = 86400;
    ...
    function _get_data()
    {
        ...
        if($data === false)
        {
			$data = array(
		    	'model_id' 	=> mt_rand(),
				'width'    	=> $this->options['width'] ? intval($this->options['width']) : 760,
				'height'   	=> $this->options['height'] ? intval($this->options['height']) : 240,
