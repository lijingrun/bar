...
//	正式环境请求基础地址
  ...
  private $API_Mobile_Pay_Base_Url = 'https://ok.yeepay.com/paymobile/';
	 ...
	 * @return string
	 */
	public function webPay($order_id,$transtime,$amount,$cardno,$idcardtype,$idcard,$owner,$product_catalog,$identity_id,$identity_type,$user_ip,$user_ua,$callbackurl='',$fcallbackurl='',$currency=156,$product_name='',$product_desc='',$terminaltype,$terminalid,$orderexp_date=60){
		$query = array(
			'orderid'	=>	$order_id,
			'transtime'	=>	$transtime,
			'currency'	=>	$currency,
