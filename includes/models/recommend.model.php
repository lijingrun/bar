...
class RecommendModel extends BaseModel
{
    ...
    function get_recommended_goods($recom_id, $num, $default_image = true, $mall_cate_id = 0, $timeslot=array(), $sort_by='') // tyioocom
    {
        ...
        else
        {
            ...
            /* 推荐商品 */
            $sql = "SELECT g.display_sgrade, g.goods_id, g.recommended, g.price_distributor, g.goods_name, g.default_image, gs.price, gs.stock,goodsstatistics.sales,s.store_id,s.store_name " .
