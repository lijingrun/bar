...
// 签名证书路径
//const SDK_SIGN_CERT_PATH = 'certs/PM_700000000000001_acp.pfx';
//define('SDK_SIGN_CERT_PATH' , dirname(__FILE__) .'/certs/PM_700000000000001_acp.pfx');
define('SDK_SIGN_CERT_PATH' , dirname(__FILE__) .'/certs/328ec.pfx');

// 签名证书密码
// const SDK_SIGN_CERT_PWD = '000000';
define('SDK_SIGN_CERT_PWD' , '198811');

// 密码加密证书（这条用不到的请随便配）
//const SDK_ENCRYPT_CERT_PATH = 'certs/verify_sign_acp.cer';
define('SDK_ENCRYPT_CERT_PATH', dirname(__FILE__) .'../certs/verify_sign_acp.cer');

// 验签证书路径（请配到文件夹，不要配到具体文件）
//const SDK_VERIFY_CERT_DIR = "certs/";
define('SDK_VERIFY_CERT_DIR', dirname(__FILE__) .'../certs/');
// 前台请求地址
...
// 前台通知地址 (商户自行配置通知地址)
//const SDK_FRONT_NOTIFY_URL = 'index.php?app=';
define('SDK_FRONT_NOTIFY_URL', '');
// 后台通知地址 (商户自行配置通知地址)
//const SDK_BACK_NOTIFY_URL = 'http://114.82.43.123/upacp_sdk_php/demo/utf8/BackReceive.php';
define('SDK_BACK_NOTIFY_URL', '');

//文件下载目录 
//const SDK_FILE_DOWN_PATH = 'file/';
define('SDK_FILE_DOWN_PATH',dirname(__FILE__) .'../file/');
